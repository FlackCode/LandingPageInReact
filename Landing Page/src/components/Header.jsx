export default function Header() {
    return ( <>
        <nav className="px-48 py-4 bg-gray-800 flex items-center w-screen justify-between">
            <div>
        ...
        <header className="px-48 py-24 bg-gray-800 flex items-center w-screen justify-between">
